...
| [`/logbook:note`](/skills/note) | Mid-session, you notice something not working well, and want the choice to fix it now, defer it to a fresh session, or just log it. |
